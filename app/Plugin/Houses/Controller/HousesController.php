<?php
App::uses('HousesAppController', 'Houses.Controller');
App::uses('HousesApiException','Houses.');
class HousesController extends HousesAppController
{
    public $layout = false;
    public $uses = array();
    protected $versions = array('v1');
    public $components = array('RequestHandler');
    protected $resources = array('houses');
    protected $methodClassMap = array('houses' => 'HousesApi');
    ...
    function handler($version = null, $resource = null, $resourceId = 0, $subResource = null, $subResourceId = null,  $subResource2 = null, $subResource2Id=null,$subResource3=null, $subResource3Id=null)
    {
        ...
        {       
            ...
            try
            {
                ...
                {
                    throw new HousesApiException( 'Please Contact API devloper', 20003 );
                }
    ...
    private function request_validator( $request=null, $requestMethod=null )
    {
        try 
        {
            ...
            {
                throw new HousesApiException( 'Version No and Resource Name must be provided', 20000 );
            }
            ...
            {
                throw new HousesApiException( 'Version No incorrect', 20001 );
            }

            //check resourses
            if (!in_array($param2, $this->resources)) 
            {
                throw new HousesApiException( 'Wrong Resource passed', 20002 );
            }
